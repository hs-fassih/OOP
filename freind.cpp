...
public:
    ...
    friend void gamechanger(); // friend function
    friend class teacher;      // attributes accessed fo a friend class in this class
    void announcement();
...
void gamechanger() // the attributes of player class are accessed and successfully manipulated int this friend function
{
    string nm;
    cout << "\nChange the name: ";
    cin >> nm;
...
int main()
{
    ...
    p1.print();
    gamechanger();
    p1.announcement(); // successfully made a class freind
    // p1.print();
}